...
const mapTwoToThe = (arr) => {
  ...
  let newArray = [];
  arr.map((e) => {
    return newArray.push(Math.pow(2, e));
  });
  return newArray;
};
/* ------------------------------------------------------------------------------------------------
...
const charCode = (arr) => {
  ...
  let newArray = [];
  arr.map((e) => {
    return newArray.push(e.charCodeAt());
  });
  return newArray;
};
...
const evenOdd = (arr) => {
  ...
  arr.map((e) => {
    if (e % 2 === 0) {
      return newArray.push("even");
    } else if (e % 2 === 1) {
      return newArray.push("odd");
    } else return newArray.push("N/A");
  });
  return newArray;
};
...
const extractAbilities = (arr) => {
  ...
  let newArray = [];
  arr.map((e) => {
    return newArray.push(e.ability.name);
  });
  return newArray;
};
...
const extractStats = (arr) => {
  ...
  let newArray = [];
  arr.map((e) => {
    return newArray.push({ name: e.stat.name, total: e.effort + e.baseStat });
  });
  return newArray;
};
