...
const { Node, KaryTree, fizzBuzzTree } = require('./k-ary-tree');

let testTree = new KaryTree(3);
...
console.log('====================================');
console.log('Testing TestTree');
console.log('====================================');
console.log('testTree.root.value:', testTree.root.value);
...
console.log('====================================');
console.log('fbTree.root.value:', fbTree.root.value);
